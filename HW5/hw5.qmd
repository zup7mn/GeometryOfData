...
Before implementing a Hamiltonian Monte Carlo Sampler, it would be helpful to recall what the hamiltonian 

```{python}
class HMC:
    def __init__(self, N = 100000, sigma = 1, step_size = 0.1):
        self.N = N
        self.sigma = sigma
